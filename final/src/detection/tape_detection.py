...
im_paths = glob.glob(f'../../object_images/*tape*') + glob.glob(f'../../object_images/*all*') + ['../../object_images/detection_tryal.png']
...
for i,im in enumerate(images):
    ...
    recognition(f'../../template_images/tape_template.png', target=equ_rgb, target_thresh=100, match_thresh=0.01, contour_error=130)
